	...
	SubShader
	{
		...
		Pass
		{
					...
					) 
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Color0);
				
				float4 _alpha_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_alpha_ST);
				float2 uv_alpha = packedInput.ase_texcoord1.xy * _alpha_ST_Instance.xy + _alpha_ST_Instance.zw;
				float _Float0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Float0);
				
				surfaceDescription.Color = _Color0_Instance.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = ( _Color0_Instance.a * pow( tex2D( _alpha, uv_alpha ).a , _Float0_Instance ) );
		...
		Pass
		{
					...
					)
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Color0);
				float4 _alpha_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_alpha_ST);
				float2 uv_alpha = packedInput.ase_texcoord.xy * _alpha_ST_Instance.xy + _alpha_ST_Instance.zw;
				float _Float0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Float0);
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 _alpha_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_alpha_ST);
				float2 uv_alpha = packedInput.ase_texcoord2.xy * _alpha_ST_Instance.xy + _alpha_ST_Instance.zw;
				float _Float0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Float0);
		...
		Pass
		{
					...
					)
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Color0);
				float4 _alpha_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_alpha_ST);
				float2 uv_alpha = packedInput.ase_texcoord3.xy * _alpha_ST_Instance.xy + _alpha_ST_Instance.zw;
				float _Float0_Instance = UNITY_ACCESS_INSTANCED_PROP(NewAmplifyShader,_Float0);
...
/*ASEBEGIN
Version=18935
130;123;1592;776;786;383;1;True;True
Node;AmplifyShaderEditor.SamplerNode;8;-402,-47;Inherit;True;Property;_alpha;alpha;0;0;Create;True;0;0;0;False;0;False;-1;d7f0d0e988f304e81822b7d2627f9f78;d7f0d0e988f304e81822b7d2627f9f78;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;-301,167;Inherit;False;InstancedProperty;_Float0;Float 0;2;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;9;-281,-246;Inherit;False;InstancedProperty;_Color0;Color 0;1;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;10.16471,16,15.74902,0.5372549;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;11;-80,83;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-18,-27;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=DB5A498DAB8AE95EE1D7A1E91335DCC0C942F66E