...
Shader "2DStocking"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _skin;
			float4 _stocking;
			float4 _stockingmaskline_ST;
			float4 _stockingmask_ST;
			float _alpha;
					...
					) 
			{
				...
				float2 uv_stockingmaskline = packedInput.ase_texcoord1.xy * _stockingmaskline_ST.xy + _stockingmaskline_ST.zw;
				float4 lerpResult90 = lerp( _skin , _stocking , max( _alpha , tex2D( _stockingmaskline, uv_stockingmaskline ).a ));
				
				float2 uv_stockingmask = packedInput.ase_texcoord1.xy * _stockingmask_ST.xy + _stockingmask_ST.zw;
				
				surfaceDescription.Color = lerpResult90.rgb;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_stockingmask = packedInput.ase_texcoord.xy * _stockingmask_ST.xy + _stockingmask_ST.zw;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_stockingmaskline = packedInput.ase_texcoord2.xy * _stockingmaskline_ST.xy + _stockingmaskline_ST.zw;
				float4 lerpResult90 = lerp( _skin , _stocking , max( _alpha , tex2D( _stockingmaskline, uv_stockingmaskline ).a ));
				
				float2 uv_stockingmask = packedInput.ase_texcoord2.xy * _stockingmask_ST.xy + _stockingmask_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 uv_stockingmask = packedInput.ase_texcoord3.xy * _stockingmask_ST.xy + _stockingmask_ST.zw;
...
/*ASEBEGIN
Version=18935
104;83;818;500;1203.378;41.55585;2.420622;True;False
Node;AmplifyShaderEditor.NormalVertexDataNode;63;-176.8312,796.9801;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;69;-247.3177,610.3856;Inherit;True;Property;_stockingmask;stocking mask;1;0;Create;True;0;0;0;False;0;False;-1;None;2b0b5746cda8b134e945965b0eae1b02;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMaxOpNode;95;-162.3015,479.0837;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;78.3372,805.4131;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;89;-614.162,444.0994;Inherit;False;Property;_alpha;alpha;4;0;Create;True;0;0;0;False;0;False;0.35;0.89;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;92;-579.6616,240.1993;Inherit;False;Property;_stocking;stocking;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;28;-276.5437,926.8702;Inherit;False;Property;_wide;wide;0;0;Create;True;0;0;0;False;0;False;0.1;0.001;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;94;-612.5934,530.7765;Inherit;True;Property;_stockingmaskline;stocking mask line;2;0;Create;True;0;0;0;False;0;False;-1;None;cc7c1ed30ae8ead4baf8519b7e6ef374;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;88;-242.4326,184.0033;Inherit;False;Property;_skin;skin;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.8224394,0.759434,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;90;147.2379,393.599;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0.6509434,0.6509434,0.6509434,0;False;2;FLOAT;0;False;1;COLOR;0
...
WireConnection;19;0;90;0
WireConnection;19;2;69;4
ASEEND*/
//CHKSM=6D9D70259AF803481441288F10FC59A6C68B1989