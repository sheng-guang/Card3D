...
Shader "Button 3D"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(Button3D)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
			UNITY_INSTANCING_BUFFER_END(Button3D)
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 _Color_Instance = UNITY_ACCESS_INSTANCED_PROP(Button3D,_Color);
				float3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				float dotResult10 = dot( -_DirectionalLightDatas[0].forward , ase_worldNormal );
				
				surfaceDescription.Color = ( _Color_Instance * (dotResult10*0.4 + 0.6) ).rgb;
...
/*ASEBEGIN
Version=18935
236;5;1385;647;780.6468;363.5368;1;True;False
Node;AmplifyShaderEditor.ColorNode;12;-234.5,-242.5;Inherit;False;InstancedProperty;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;236.3532,-109.5368;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.DotProductOpNode;10;-250.5,12.5;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;7;-523.5,-66.5;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldNormalVector;11;-507.5,89.5;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ScaleAndOffsetNode;14;-40.64679,24.4632;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0.4;False;2;FLOAT;0.6;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=18D30BAB8F135330CE41FA06240817AA637ED29B