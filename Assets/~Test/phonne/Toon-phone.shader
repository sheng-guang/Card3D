	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				Gradient gradient12_g1 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.4800031 ), float4( 1, 1, 1, 0.5199969 ), float4( 1, 1, 1, 0.7617609 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				float dotResult4_g1 = dot( reflect( _DirectionalLightDatas[0].forward , ase_worldNormal ) , V );
				
				surfaceDescription.Color = SampleGradient( gradient12_g1, pow( max( dotResult4_g1 , 0.0 ) , 5.0 ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float dotResult4_g1 = dot( reflect( _DirectionalLightDatas[0].forward , ase_worldNormal ) , ase_worldViewDir );
...
/*ASEBEGIN
Version=18933
269;93;1385;689;692.5;344.5;1;True;False
Node;AmplifyShaderEditor.FunctionNode;7;-322.5,34.5;Inherit;False;ToonHightLight;-1;;1;1fe4f530f70aab84086cf91b33178994;0;1;13;FLOAT;5;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C4896F28A3A1F6E262F81A759190B92E948C09BD