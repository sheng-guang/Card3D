...
Shader "b-phone"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_Float0("Float 0", Float) = 10
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(bphone)
				UNITY_DEFINE_INSTANCED_PROP(float, _Float0)
			UNITY_INSTANCING_BUFFER_END(bphone)
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 normalizeResult11 = normalize( ( -_DirectionalLightDatas[0].forward + V ) );
				float dotResult13 = dot( ase_worldNormal , normalizeResult11 );
				float _Float0_Instance = UNITY_ACCESS_INSTANCED_PROP(bphone,_Float0);
				float3 temp_cast_0 = (pow( max( dotResult13 , 0.0 ) , _Float0_Instance )).xxx;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float3 normalizeResult11 = normalize( ( -_DirectionalLightDatas[0].forward + ase_worldViewDir ) );
				float dotResult13 = dot( ase_worldNormal , normalizeResult11 );
				float _Float0_Instance = UNITY_ACCESS_INSTANCED_PROP(bphone,_Float0);
				float3 temp_cast_0 = (pow( max( dotResult13 , 0.0 ) , _Float0_Instance )).xxx;
...
/*ASEBEGIN
Version=18933
226;330;1385;689;-84.42773;188.0467;1;True;False
Node;AmplifyShaderEditor.SimpleAddOpNode;10;15.5,18;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.NormalizeNode;11;247.6895,44.50919;Inherit;True;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DotProductOpNode;13;479.0012,-72.42133;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;12;218.0012,-138.4213;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SimpleMaxOpNode;14;715.0012,20.57867;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;15;950.0012,104.5787;Inherit;True;False;2;0;FLOAT;0;False;1;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;9;-276.5,98;Inherit;True;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;8;-343.5001,-117.4;Inherit;True;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;16;721.4277,267.9533;Inherit;False;InstancedProperty;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;0;1255.092,44.74161;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;14;b-phone;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;0;0;  Rendering Pass ;0;0;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;1;0;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;1;0;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;1;0;DOTS Instancing;0;0;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;7;True;True;True;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=FCC24FCA7F51F66473A58C5717EEA57AC507C599