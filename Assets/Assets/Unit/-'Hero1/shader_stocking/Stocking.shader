...
Shader "Stocking"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(Stocking)
			...
			UNITY_INSTANCING_BUFFER_END(Stocking)
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 lerpResult59 = lerp( _skincolor , _stockingcolor , _stockingcolor.a);
				...
				float _MinColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Stocking,_MinColor);
				float4 temp_cast_0 = (_MinColor_Instance).xxxx;
				float _MaxColor_Instance = UNITY_ACCESS_INSTANCED_PROP(Stocking,_MaxColor);
				...
				float4 _TextureSample0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Stocking,_TextureSample0_ST);
				float2 uv_TextureSample0 = packedInput.ase_texcoord2.xy * _TextureSample0_ST_Instance.xy + _TextureSample0_ST_Instance.zw;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 _TextureSample0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Stocking,_TextureSample0_ST);
				float2 uv_TextureSample0 = packedInput.ase_texcoord.xy * _TextureSample0_ST_Instance.xy + _TextureSample0_ST_Instance.zw;
		...
		Pass
		{
					...
					)
			{
				...
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float4 _TextureSample0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(Stocking,_TextureSample0_ST);
				float2 uv_TextureSample0 = packedInput.ase_texcoord3.xy * _TextureSample0_ST_Instance.xy + _TextureSample0_ST_Instance.zw;
...
/*ASEBEGIN
Version=18935
0;228;1385;683;938.925;24.34753;1.370489;True;False
Node;AmplifyShaderEditor.NormalVertexDataNode;63;-62.79628,1029.35;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-162.5088,1159.24;Inherit;False;Property;_wide;wide;3;0;Create;True;0;0;0;False;0;False;0.1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GradientNode;44;-1438.209,-408.1892;Inherit;False;0;3;2;0,0,0,0.4800031;1,1,1,0.5199969;1,1,1,0.7617609;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;55;-272.0833,915.2892;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GradientNode;54;-315,825.4297;Inherit;False;1;2;2;0,0,0,0.5000076;1,1,1,0.7617609;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.RangedFloatNode;46;-807.5079,-75.90605;Inherit;False;InstancedProperty;_MinColor;MinColor;5;0;Create;True;0;0;0;False;0;False;0.1735088;0.53;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-478.4142,1091.126;Inherit;False;Property;_add;add;6;0;Create;True;0;0;0;False;0;False;0;-0.21;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;59;-373.5477,-400.6669;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;69;-201.836,550.3107;Inherit;True;Property;_TextureSample0;Texture Sample 0;9;0;Create;True;0;0;0;False;0;False;-1;None;2b0b5746cda8b134e945965b0eae1b02;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;60;-81.01092,-140.0377;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NegateNode;52;-494.4999,874.1298;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;40;-1321.797,-148.6225;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;30;192.372,1037.783;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-824.2469,20.90247;Inherit;False;InstancedProperty;_MaxColor;MaxColor;4;0;Create;True;0;0;0;False;0;False;1;0.73;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;51;-724.8259,920.4586;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;58;-726.3415,-578.7656;Inherit;False;Property;_skincolor;skin color;7;0;Create;True;0;0;0;False;0;False;1,0.8247273,0.759,0;1,0.8247273,0.759,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;66;-562.8768,124.7589;Float;False;Property;_RimPower;Rim Power;1;0;Create;True;0;0;0;False;0;False;0.8317261;0.8317261;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;67;-557.0548,282.5577;Float;False;Property;_RimColor;Rim Color-------------------;2;1;[HDR];Create;True;0;0;0;False;0;False;0,1,0.8758622,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientSampleNode;53;-78.00011,779.4297;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;57;-713.3647,-395.7455;Inherit;False;Property;_stockingcolor;stocking color;8;0;Create;True;0;0;0;False;0;False;0,0,0,0.5803922;0,0,0,0.8313726;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;64;-563.3124,196.7473;Float;False;Property;_RimOffset;Rim Offset;0;0;Create;True;0;0;0;False;0;False;0.24;0.24;-1;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=1FBB038E9A1792B72B5B5A00477F5CC0BDE881C7