...
Shader "ToonSkin"
{
	Properties
	{
		...
		[ASEBegin]_envcolor("env color", Range( 0 , 0.01)) = 0
		_Texture0("Texture 0", 2D) = "white" {}
		[ASEEnd]_envlightpower("env light power", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				Gradient gradient13_g2 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.4800031 ), float4( 1, 1, 1, 0.5199969 ), float4( 1, 1, 1, 0.7617609 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float3 ase_worldNormal = packedInput.ase_texcoord2.xyz;
				float dotResult9_g2 = dot( ase_worldNormal , -_DirectionalLightDatas[0].forward );
				float4 temp_cast_0 = (0.6).xxxx;
				float4 temp_cast_1 = (1.0).xxxx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float3 bakedGI13 = SampleBakedGI( ase_worldPos, ase_worldNormal, packedInput.ase_lightmapUVs.xy, packedInput.ase_lightmapUVs.zw );
				float3 temp_cast_2 = (_envlightpower).xxx;
				
				surfaceDescription.Color = ( tex2D( _Texture0, uv_Texture0 ) * ( (temp_cast_0 + (SampleGradient( gradient13_g2, saturate( (dotResult9_g2*0.5 + 0.5) ) ) - float4( 0,0,0,0 )) * (temp_cast_1 - temp_cast_0) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) + float4( pow( ( bakedGI13 * _envcolor ) , temp_cast_2 ) , 0.0 ) ) ).rgb;
...
/*ASEBEGIN
Version=18912
101;73;780;655;581.3087;201.6872;1;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;11;-554.7976,-448.6434;Inherit;True;Property;_Texture0;Texture 0;1;0;Create;True;0;0;0;False;0;False;a30f5f9cccbf89845977f0fd57e12a89;a30f5f9cccbf89845977f0fd57e12a89;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;9;339.1258,-181.447;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-903.7461,-61.75871;Inherit;False;Property;_ro;ro;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;24;-1285.746,-121.7587;Inherit;False;Property;_Float0;Float 0;3;0;Create;True;0;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RotatorNode;19;-774.7461,-224.7587;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.PowerNode;26;-93.01306,118.9844;Inherit;False;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;12;99.72602,-96.24637;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ScaleAndOffsetNode;23;-966.7461,-215.7587;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-331.3716,94.90323;Inherit;True;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-646.0717,367.0963;Inherit;False;Property;_envcolor;env color;0;0;Create;True;0;0;0;False;0;False;0;0.0032;0;0.01;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;25;-337.774,-50.24701;Inherit;False;Toon diffuse;-1;;2;f8624219d58f6e645bc9569650429b82;0;2;14;FLOAT;0.6;False;15;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;10;-220.7743,-323.2464;Inherit;True;Property;_color;color-------------;3;0;Create;True;0;0;0;False;0;False;-1;cf6458571683a21438f14637c025d623;434d5ea708dd0fa45a35bdf813cb81f9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexCoordVertexDataNode;20;-1244.462,-242.6144;Inherit;False;0;2;0;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;27;-226.3087,318.3128;Inherit;False;Property;_envlightpower;env light power;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IndirectDiffuseLighting;13;-651.4784,101.7606;Inherit;True;Tangent;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;568.3395,-157.8722;Float;False;True;-1;2;Rendering.HighDefinition.HDUnlitGUI;0;14;ToonSkin;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;-20;0;True;-21;1;0;True;-22;0;True;-23;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;-26;False;False;False;False;False;False;False;False;False;True;True;0;True;-5;255;False;-1;255;True;-6;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-24;True;0;True;-32;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;29;Surface Type;0;  Rendering Pass ;0;  Rendering Pass;1;  Blending Mode;0;  Receive Fog;1;  Distortion;0;    Distortion Mode;0;    Distortion Only;1;  Depth Write;1;  Cull Mode;0;  Depth Test;4;Double-Sided;0;Alpha Clipping;0;Motion Vectors;1;  Add Precomputed Velocity;0;Shadow Matte;0;Cast Shadows;1;DOTS Instancing;0;GPU Instancing;1;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;7;True;True;True;True;True;True;False;False;;False;0
...
ASEEND*/
//CHKSM=DD94E8C354D71B376B680D9E7D4CB73EA3DAE94F