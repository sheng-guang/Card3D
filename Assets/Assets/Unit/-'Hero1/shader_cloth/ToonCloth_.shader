...
Shader "ToonCloth_111"
{
	Properties
	{
		...
		[ASEEnd]_Float0("Float 0", Range( 0 , 0.01)) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				Gradient gradient12_g21 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.4800031 ), float4( 1, 1, 1, 0.5199969 ), float4( 1, 1, 1, 0.7617609 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float3 ase_worldNormal = packedInput.ase_texcoord1.xyz;
				float3 normalizeResult15_g21 = normalize( ( -_DirectionalLightDatas[0].forward + V ) );
				float dotResult16_g21 = dot( ase_worldNormal , normalizeResult15_g21 );
				Gradient gradient13_g18 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.4800031 ), float4( 1, 1, 1, 0.5199969 ), float4( 1, 1, 1, 0.7617609 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float dotResult9_g18 = dot( ase_worldNormal , -_DirectionalLightDatas[0].forward );
				float4 temp_cast_0 = (0.6).xxxx;
				float4 temp_cast_1 = (1.0).xxxx;
				float dotResult4_g20 = dot( ase_worldNormal , V );
				...
				surfaceDescription.Color = ( ( SampleGradient( gradient12_g21, pow( max( dotResult16_g21 , 0.0 ) , 7.62 ) ) + (temp_cast_0 + (SampleGradient( gradient13_g18, saturate( (dotResult9_g18*0.5 + 0.5) ) ) - float4( 0,0,0,0 )) * (temp_cast_1 - temp_cast_0) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 ))) + ( ( 1.0 * saturate( pow( ( 1.0 - saturate( ( dotResult4_g20 + _RimOffset ) ) ) , _RimPower ) ) ) * ( _RimColor * float4( saturate( _DirectionalLightDatas[0].color.rgb ) , 0.0 ) ) ) + float4( ( bakedGI26 * _Float0 ) , 0.0 ) ) * tex2D( _color, uv_color ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float3 normalizeResult15_g21 = normalize( ( -_DirectionalLightDatas[0].forward + ase_worldViewDir ) );
				float dotResult16_g21 = dot( ase_worldNormal , normalizeResult15_g21 );
				Gradient gradient13_g18 = NewGradient( 0, 3, 2, float4( 0, 0, 0, 0.4800031 ), float4( 1, 1, 1, 0.5199969 ), float4( 1, 1, 1, 0.7617609 ), 0, 0, 0, 0, 0, float2( 1, 0 ), float2( 1, 1 ), 0, 0, 0, 0, 0, 0 );
				float dotResult9_g18 = dot( ase_worldNormal , -_DirectionalLightDatas[0].forward );
				float4 temp_cast_0 = (0.6).xxxx;
				float4 temp_cast_1 = (1.0).xxxx;
				float dotResult4_g20 = dot( ase_worldNormal , ase_worldViewDir );
				float3 bakedGI26 = SampleBakedGI( ase_worldPos, ase_worldNormal, packedInput.ase_lightmapUVs.xy, packedInput.ase_lightmapUVs.zw );
				float2 uv_color = packedInput.ase_texcoord3.xy * _color_ST.xy + _color_ST.zw;
...
/*ASEBEGIN
Version=18933
226;330;1385;689;1446.759;1701.584;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;96;-1201.427,-1469.767;Inherit;False;Constant;_highlightpower;high light power;8;0;Create;True;0;0;0;False;0;False;7.62;0;0;15;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;75;-1105.4,-1147.22;Float;False;Property;_RimOffset;Rim Offset;2;0;Create;True;0;0;0;False;0;False;0.24;-0.31;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-830.754,-735.8549;Inherit;False;Property;_Float0;Float 0;4;0;Create;True;0;0;0;False;0;False;0;0.0015;0;0.01;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;103;-325.1821,-1291.428;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;102;-995.962,-1343.259;Inherit;False;Toon diffuse;-1;;18;f8624219d58f6e645bc9569650429b82;0;2;14;FLOAT;0.6;False;15;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;100;25.42821,-848.9305;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-1104.965,-1219.208;Float;False;Property;_RimPower;Rim Power;1;0;Create;True;0;0;0;False;0;False;0.8317261;3;0;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;104;-856.0004,-1472.754;Inherit;False;ToonHightLight;-1;;19;1fe4f530f70aab84086cf91b33178994;0;1;13;FLOAT;7.62;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;36;-424.5345,-608.3411;Inherit;True;Property;_color;color-------------;3;0;Create;True;0;0;0;False;0;False;-1;cf6458571683a21438f14637c025d623;434d5ea708dd0fa45a35bdf813cb81f9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;85;-774.4131,-1221.071;Inherit;True;rim;-1;;20;50b81ff80f24ef24493b47e052379a4c;0;4;21;FLOAT;1;False;19;FLOAT;0.5;False;18;FLOAT;0;False;20;COLOR;0,1,0.8758622,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;108;-845.7585,-1552.584;Inherit;False;ToonHightLight(b-phone);-1;;21;9c0b70fe788c96a4aa8c0ffcabb653d3;0;1;13;FLOAT;5;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;34;-1099.143,-1061.41;Float;False;Property;_RimColor;Rim Color-------------------;0;1;[HDR];Create;True;0;0;0;False;0;False;0,1,0.8758622,0;8,8,8,0.8588235;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;108;13;96;0
WireConnection;106;0;26;0
WireConnection;106;1;107;0
WireConnection;0;0;100;0
ASEEND*/
//CHKSM=142934FD1BF06E16A85E4E181AE045E6E8E2694E