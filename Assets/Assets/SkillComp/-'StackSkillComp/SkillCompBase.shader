...
Shader "SkillCompBase"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(SkillCompBase)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Color0)
			UNITY_INSTANCING_BUFFER_END(SkillCompBase)
					...
					) 
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(SkillCompBase,_Color0);
...
/*ASEBEGIN
Version=18935
0;73;360;577;149.5;267.5;1;False;False
