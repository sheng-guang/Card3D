	...
	SubShader
	{
		...
		Pass
		{
					...
					) 
			{
				...
				surfaceDescription.Color = color9.rgb;
				surfaceDescription.Emission = 0;
				surfaceDescription.Alpha = 0.2;
