...
Shader "LongSkillComp"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			#endif
			CBUFFER_END
			UNITY_INSTANCING_BUFFER_START(LongSkillComp)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Color0)
			UNITY_INSTANCING_BUFFER_END(LongSkillComp)
					...
					) 
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(LongSkillComp,_Color0);
...
/*ASEBEGIN
Version=18935
7;316;1385;621;662;289.5;1;True;False
Node;AmplifyShaderEditor.ColorNode;7;-139.5,-94.5;Inherit;False;InstancedProperty;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
