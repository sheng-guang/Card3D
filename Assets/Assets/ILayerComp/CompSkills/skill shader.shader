...
Shader "ButtonImage"
{
	Properties
	{
		...
		[ASEEnd]_MainTex_ST("MainTex_ST", Vector) = (0,0,0,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			CBUFFER_END
			sampler2D _Texture;
			UNITY_INSTANCING_BUFFER_START(ButtonImage)
				UNITY_DEFINE_INSTANCED_PROP(float4, _Color)
				UNITY_DEFINE_INSTANCED_PROP(float4, _MainTex_ST)
			UNITY_INSTANCING_BUFFER_END(ButtonImage)
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 _Color_Instance = UNITY_ACCESS_INSTANCED_PROP(ButtonImage,_Color);
				float4 _MainTex_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ButtonImage,_MainTex_ST);
				float2 appendResult17 = (float2(_MainTex_ST_Instance.x , _MainTex_ST_Instance.y));
				float2 appendResult18 = (float2(_MainTex_ST_Instance.z , _MainTex_ST_Instance.w));
				float2 texCoord15 = packedInput.ase_texcoord1.xy * appendResult17 + appendResult18;
				
				surfaceDescription.Color = ( _Color_Instance * tex2D( _Texture, texCoord15 ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 appendResult17 = (float2(_MainTex_ST_Instance.x , _MainTex_ST_Instance.y));
				float2 appendResult18 = (float2(_MainTex_ST_Instance.z , _MainTex_ST_Instance.w));
				float2 texCoord15 = packedInput.ase_texcoord.xy * appendResult17 + appendResult18;
...
/*ASEBEGIN
Version=18935
236;5;1385;647;863.5482;407.4731;1;True;False
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;224.4518,-74.47311;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.Vector4Node;14;-662.5482,-54.47311;Inherit;False;InstancedProperty;_MainTex_ST;MainTex_ST;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;11;-104.5,-35.5;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;18;-473.5482,71.52689;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-329.5482,-11.47311;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.DynamicAppendNode;17;-471.5482,-46.47311;Inherit;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.ColorNode;12;-87.54822,-229.4731;Inherit;False;InstancedProperty;_Color;Color;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=FE2ED6F584C0F496978C42E0298220FFD22280AD