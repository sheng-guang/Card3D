	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(ButtonImage,_Color0);
				float4 _Texture_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ButtonImage,_Texture_ST);
				float2 uv_Texture = packedInput.ase_texcoord1.xy * _Texture_ST_Instance.xy + _Texture_ST_Instance.zw;
				
				surfaceDescription.Color = ( _Color0_Instance * tex2D( _Texture, uv_Texture ) ).rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 _Color0_Instance = UNITY_ACCESS_INSTANCED_PROP(ButtonImage,_Color0);
				float4 _Texture_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(ButtonImage,_Texture_ST);
				float2 uv_Texture = packedInput.ase_texcoord.xy * _Texture_ST_Instance.xy + _Texture_ST_Instance.zw;
...
/*ASEBEGIN
Version=18935
236;5;1385;647;689.5482;442.4731;1;True;False
Node;AmplifyShaderEditor.SamplerNode;11;-169.5,-113.5;Inherit;True;Property;_Texture;Texture;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;195.4518,-139.4731;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;12;-125.5482,-309.4731;Inherit;False;InstancedProperty;_Color0;Color 0;1;1;[HDR];Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=E582E9A3C6E79F61CD321B828992088FE0235FBD