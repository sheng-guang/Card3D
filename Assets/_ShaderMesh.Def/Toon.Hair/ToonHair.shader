// Upgrade NOTE: upgraded instancing buffer 'Def_toonToonHair' to new syntax.
// Upgrade NOTE: upgraded instancing buffer 'Def_toonToonHairOutline' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Def_toon/ToonHair"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(Def_toonToonHairOutline)
		UNITY_DEFINE_INSTANCED_PROP( float4, _ASEOutlineColor )
#define _ASEOutlineColor_arr Def_toonToonHairOutline
		UNITY_DEFINE_INSTANCED_PROP( float, _ASEOutlineWidth )
#define _ASEOutlineWidth_arr Def_toonToonHairOutline
		UNITY_INSTANCING_BUFFER_END(Def_toonToonHairOutline)
		...
		UNITY_INSTANCING_BUFFER_START(Def_toonToonHair)
			UNITY_DEFINE_INSTANCED_PROP(float4, _Color0)
#define _Color0_arr Def_toonToonHair
			UNITY_DEFINE_INSTANCED_PROP(float4, _Diffuse_ST)
#define _Diffuse_ST_arr Def_toonToonHair
		UNITY_INSTANCING_BUFFER_END(Def_toonToonHair)
...
ASEEND*/
//CHKSM=EBDE74C8E3DB343342F4E0AD9BEE4E15AB1FEB48