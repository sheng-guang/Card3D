	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 temp_cast_0 = (dotResult19).xxx;
...
ASEEND*/
//CHKSM=D5C6843A04207CA0CA199C128A43AE86E9E7E537